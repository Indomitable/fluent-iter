...
//         expect(from([]).firstOrDefault(5)).toBe(5);

//         expect(from([1, 2, 3]).firstOrDefault(5, (x) => x === 2)).toBe(2);
//         expect(from([]).firstOrDefault(5, (x) => x === 10)).toBe(5);
...
//         expect(from([]).lastOrDefault(5)).toBe(5);

//         expect(from([1, 2, 3]).lastOrDefault(5, (x) => x === 2)).toBe(2);
//         expect(from([]).lastOrDefault(5, (x) => x === 10)).toBe(5);
